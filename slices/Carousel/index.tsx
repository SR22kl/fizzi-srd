...
const Carousel: FC<CarouselProps> = ({ slice }) => {
  ...
  function changeFlavor(index: number) {
    ...
    tl.to(
      ...
      .call(() => setCurrentFlavorIndex(nextIndex), [], 0.5)
...
function ArrowButton({
  ...
  return (
    <button
      onClick={onClick}
      className="size-12 rounded-full border-2 border-white bg-white/10 p-3 opacity-85 ring-white cursor-pointer focus:outline-none focus-visible:opacity-100 focus-visible:ring-4 md:size-16 lg:size-20"
    >
